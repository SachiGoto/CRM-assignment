...
class Clients{
  ...
  if(mysqli_connect_error()){
    ...
    public function viewData(){
             $sql = " SELECT ID, business_name, contact_name, email, phone, enquiry, products FROM contact_info";
    ...
    //    inserting data
       $sql = "INSERT INTO contact_info(business_name, contact_name, email, phone, enquiry, products) VALUES ('$business_name','$contact_name','$email','$phone', '$enquiry' , '$products')" ;
  ...
  public function updateClient($postData){
       ...
       if(!empty($id) && !empty($postData)){
        ...
        $sql = "UPDATE contact_info SET business_name='$business_name', contact_name ='$contact_name', email='$email', phone='$phone',  enquiry='$enquiry', products = '$products',ID='$id' WHERE ID='$id'";
